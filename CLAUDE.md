...
This project is indexed by GitNexus as **SimTradeLab** (5020 symbols, 6400 relationships, 49 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
